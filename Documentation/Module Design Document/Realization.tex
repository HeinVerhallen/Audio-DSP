...
Robin
%Verwijs naar "DSP minor - General\References\AN_Legacy_pin_1_problems.pdf" voor plaatsing van de 0R jumpers.
%Verwijs naar "DSP minor - General\References\WP_The_G_word.pdf" voor de reden van de 0R jumpers.
%Verwijs naar "DSP minor - General\References\Supply_decoupling.pdf" voor de reden van de serieweerstanden bij de low noise voedingen.
...
Silas
%Verwijs naar "DSP minor - General\References\WP_The_G_word.pdf" voor plaatsing van de 0R jumpers.

%Ideëen om over te vertellen:
%Waarom veel sporen differential zijn gerout
%
%
%
