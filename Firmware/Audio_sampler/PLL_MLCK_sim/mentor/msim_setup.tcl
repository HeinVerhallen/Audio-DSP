...
# ----------------------------------------
# If PLL_MLCK is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2023.04.20.19:21:00
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_MLCK.vho"
}
