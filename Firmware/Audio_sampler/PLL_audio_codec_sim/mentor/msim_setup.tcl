...
# ----------------------------------------
# If PLL_audio_codec is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2023.07.11.13:00:05
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_audio_codec"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_audio_codec.vho"
}
