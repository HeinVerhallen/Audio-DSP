...
# ----------------------------------------
# If PLL_overclock is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2023.05.26.17:15:25
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_overclock"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_overclock.vho"
}
