...
# ----------------------------------------
# If PLL_overclocking is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2023.05.26.16:18:08
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_overclocking"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_overclocking.vho"
}
