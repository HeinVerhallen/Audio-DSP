factor = 4;
f0 = 40;        %resonance frequency of BPF 0
...
f4 = f3*factor; %resonance frequency of BPF 3
% f1 = 1e3;
% f2 = 1e3;
k0 = sqrt(2);     %gain of BPF 0
k1 = sqrt(2);     %gain of BPF 1
k2 = sqrt(2);     %gain of BPF 2
k3 = sqrt(2);     %gain of BPF 3
k4 = sqrt(2);     %gain of BPF 4
% dt = 1e-6;  %sample time
dt = 1/192000;
...
A4 = [-2*pi*f4 0; -k4*2*pi*f4 -2*pi*f4];
B4 = [2*pi*f4; k4*2*pi*f4];
C4 = [0 1];
D4 = 0;
...
filtOut4 = zeros(2, length(filtIn));
...
for n = 1:length(t)-1
    ...
    filtOut4(1, n+1) = Ad4(1,1)*filtOut4(1,n) + Ad4(1,2)*filtOut4(2,n) + Bd4(1)*filtIn(n);
    filtOut4(2, n+1) = Ad4(2,1)*filtOut4(1,n) + Ad4(2,2)*filtOut4(2,n) + Bd4(2)*filtIn(n);
    
    filtOut(1, n+1) = filtOut0(1, n+1) + filtOut1(1, n+1) + filtOut2(1, n+1) + filtOut3(1, n+1) + filtOut4(1, n+1);
    filtOut(2, n+1) = filtOut0(2, n+1) + filtOut1(2, n+1) + filtOut2(2, n+1) + filtOut3(2, n+1) + filtOut4(2, n+1);
end
